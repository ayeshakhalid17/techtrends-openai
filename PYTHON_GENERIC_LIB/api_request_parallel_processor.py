...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_requests_per_minute", type=int, default=3000 * 0.5)
    parser.add_argument("--max_tokens_per_minute", type=int, default=250000 * 0.5)
...
filename = "data/linkedinjobs5.jsonl"
n_requests = 5
jobs = [{"model": "text-genration-model", "input": str(x) + "\n"} for x in range(n_requests)]
